        ...
        <div className="flex flex-1 items-center justify-end gap-2 lg:hidden">
          ...
          >
            <span className="relative block h-5 w-5">
              <span style={{ position: 'absolute', left: 0, right: 0, height: '1.5px', backgroundColor: 'currentColor', borderRadius: '1px', top: mobileOpen ? '50%' : '22%', transform: mobileOpen ? 'translateY(-50%) rotate(45deg)' : 'translateY(-50%) rotate(0deg)', transition: 'top 0.25s ease, transform 0.25s ease' }} />
              <span style={{ position: 'absolute', left: 0, right: 0, height: '1.5px', backgroundColor: 'currentColor', borderRadius: '1px', top: '50%', transform: 'translateY(-50%)', opacity: mobileOpen ? 0 : 1, transition: 'opacity 0.2s ease' }} />
              <span style={{ position: 'absolute', left: 0, right: 0, height: '1.5px', backgroundColor: 'currentColor', borderRadius: '1px', top: mobileOpen ? '50%' : '78%', transform: mobileOpen ? 'translateY(-50%) rotate(-45deg)' : 'translateY(-50%) rotate(0deg)', transition: 'top 0.25s ease, transform 0.25s ease' }} />
            </span>
          </button>
        </div>
      </Container>
                    ...
                    <div key={item.href}>
                      ...
                      >
                        ...
                        <svg
                          ...
                          style={{ transform: mobileExpanded === item.href ? 'rotate(180deg)' : 'rotate(0deg)' }}
                          aria-hidden="true"
                        >
                          <path d="M5.5 7.5a1 1 0 0 1 1.4 0L10 10.6l3.1-3.1a1 1 0 1 1 1.4 1.4l-3.8 3.8a1 1 0 0 1-1.4 0L5.5 8.9a1 1 0 0 1 0-1.4Z" />
                        </svg>
                      </button>
                      <div style={{ display: 'grid', gridTemplateRows: mobileExpanded === item.href ? '1fr' : '0fr', transition: 'grid-template-rows 0.28s cubic-bezier(0.4, 0, 0.2, 1)' }}>
                        <div style={{ overflow: 'hidden' }}>
